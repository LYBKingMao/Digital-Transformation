...
demo = {
  ...
  initDashboardPageCharts: function() {
    ...
    var ctx = document.getElementById("chartLineYellow").getContext("2d");

    var gradientStroke = ctx.createLinearGradient(0, 230, 0, 50);

    gradientStroke.addColorStop(1, 'rgba(102, 209, 122,0.2)');
    ...
    gradientStroke.addColorStop(1, 'rgba(102, 209, 122,0.1)');
    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        labels: ['0G/028', '0G/034', '02/033', '02/027', '0G/034', '01/020'],
        datasets: [{
          label: "Countries",
          fill: true,
          backgroundColor: gradientStroke,
